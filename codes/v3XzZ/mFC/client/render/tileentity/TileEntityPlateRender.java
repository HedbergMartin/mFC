...
import v3XzZ.mFC.client.models.ModelPlate;
...
public class TileEntityPlateRender extends TileEntitySpecialRenderer {
	...
	private void renderPlate(TileEntityPlate plate, float i, float j, float k, float var8) {
        this.func_110628_a(Textures.MODEL_PLATE);
		/** =========================Plate============================= */
		GL11.glPushMatrix();
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		this.renderPlate((TileEntityPlate) var1, (float)var2, (float)var4, (float)var6, var8);
	}
}
