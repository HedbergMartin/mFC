...
import v3XzZ.mFC.client.models.ModelShelf;
...
public class TileEntityShelfRender extends TileEntitySpecialRenderer {
	...
	private void renderShelf(TileEntityShelf shelf, float i, float j, float k, float var8) {
        ...
        if (shelf.hasWorldObj())
        {
            var9 = shelf.getBlockMetadata();
        }
		/** =========================All_Main_Objects============================= */
        this.func_110628_a(Textures.MODEL_SHELF);
		GL11.glPushMatrix();
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		this.renderShelf((TileEntityShelf) var1, (float)var2, (float)var4, (float)var6, var8);
	}
}