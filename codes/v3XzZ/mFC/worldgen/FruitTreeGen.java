 ...
 * 
 */
public class FruitTreeGen extends net.minecraft.world.gen.feature.WorldGenerator
{
    ...
    private final int blockLeaves;
    
    /** Determent if the tree is handgrown */
    private final boolean handGrown;

    public FruitTreeGen(boolean par1, int par2, int par3, int par4, boolean par5, boolean par6)
    {
        super(par1);
    ...
    {
        int l = par2Random.nextInt(4) + this.minTreeHeight;
        int leavesStage = par2Random.nextInt(3)+1;
        if(this.handGrown) {
        	leavesStage = 0;
        }
        boolean flag = true;
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (FruitSaplings)Blocks.fruitSaplings));
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(par1World, j2, j1, l2, this.blockLeaves, this.randomizeLeaves(par2Random, leavesStage));
                                    }
                                }
                            }
                        }
    ...
    private int randomizeLeaves(Random rand, int stage) {
    	if(rand.nextInt(2) == 0) {
    		return 0;
    	}
    	return stage;
