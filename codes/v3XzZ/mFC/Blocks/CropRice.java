...
public class CropRice extends CropTemplate
{
    ...
    {
        return i == Block.blockClay.blockID;
    }
    ...
    private float getGrowthRate(World par1World, int par2, int par3, int par4)
    {
        ...
        for (int var17 = par2 - 1; var17 <= par2 + 1; ++var17)
        {
            for (int var18 = par4 - 1; var18 <= par4 + 1; ++var18)
            {
                ...
                if (var19 == Block.blockClay.blockID)
                {
                    var20 = 1.0F;
    ...
    public void dropBlockAsItemWithChance(World world, int i, int j, int k, int l, float f, int i1)
    {
        ...
        for(int i2 = 0; i2 < 3; i2++)
        {
            if(world.rand.nextInt(10) <= l)
            {
                ...
                EntityItem entityitem = new EntityItem(world, (float)i + f2, (float)j + f3, (float)k + f4, new ItemStack(Items.riceSeeds));
