...
public class NameRegister 
{
	public static void addName()
	{
		...
		LanguageRegistry.addName(Items.moldCheese, "Cheese Mold(Cheese)");
		LanguageRegistry.addName(Items.cheeseWheel, "Cheese Block");
		LanguageRegistry.addName(Items.cheesePiece, "Piece of Cheese");
		LanguageRegistry.addName(Items.glassWater, "Glass of Water");
		LanguageRegistry.addName(Items.drinkingGlass, "Drinking Glass");
		...
		LanguageRegistry.addName(Items.friedEgg, "Fried Egg");
		...
		//Pies
		LanguageRegistry.addName(Items.itemApplePie, "ApplePie");
		LanguageRegistry.addName(Items.itemTacoPie, "TacoPie");
		...
		//New
		LanguageRegistry.addName(Items.onion, "Onion");
		LanguageRegistry.addName(Items.strawBerry, "Strawberry");
		LanguageRegistry.addName(Items.raspBerry, "Raspberry");
		LanguageRegistry.addName(Items.grapes, "Grapes");
		LanguageRegistry.addName(Items.palt, "Palt");
		LanguageRegistry.addName(Items.beerCup, "Beer cup");
		LanguageRegistry.addName(Items.beer, "Beer");
		LanguageRegistry.addName(Items.redWine, "Red Wine");
		LanguageRegistry.addName(Items.whiteWine, "White Wine");
		LanguageRegistry.addName(Items.tallBottle, "Tall glass bottle");
		LanguageRegistry.addName(Items.christmasMust, "Christmas-must / Julmust");
		LanguageRegistry.addName(Items.beerBase, "Beer base");
		LanguageRegistry.addName(Items.redWineBase, "Red Wine base");
		LanguageRegistry.addName(Items.whiteWineBase, "White Wine base");
		LanguageRegistry.addName(Items.christmasMustBase, "Christmas-must base");
		
		LanguageRegistry.addName(Blocks.saltBlock, "Salt block");
		...
		LanguageRegistry.addName(Items.RaspBerryjam, "Raspberry jam");
		LanguageRegistry.addName(Items.chocolateBar, "Chocolate Bar");
		LanguageRegistry.addName(Items.glassStrawBerryJuice, "Strawberry Juice");
		LanguageRegistry.addName(Items.glassRaspBerryJuice, "Raspberry Juice");
		...
		LanguageRegistry.addName(Items.beefSoup, "Beef soup");
		LanguageRegistry.addName(Blocks.grapePlant, "Grape Crop");
		LanguageRegistry.addName(Blocks.onionPlant, "Onion Crop");
		...
		LanguageRegistry.addName(Blocks.redSeedling, "Red Flower Seedling");
		...
		LanguageRegistry.addName(Items.tomatoSeeds, "Tomato Seeds");
		LanguageRegistry.addName(Items.raspBerrySeeds, "RaspBerry Seeds");
		...
		LanguageRegistry.addName(Items.Rice, "Rice");
		LanguageRegistry.addName(Items.orange, "Orange");
		LanguageRegistry.addName(Items.avacado, "Avocado");
		LanguageRegistry.addName(Items.guacamole, "Guacamole");
		LanguageRegistry.addName(Items.orangeJuice, "Orange Juice");
		LanguageRegistry.addName(Items.grapeSeeds, "Grape Seeds");
		LanguageRegistry.addName(Blocks.plate, "Plate");
		LanguageRegistry.addName(Items.gingerBread, "Gingerbread");
		LanguageRegistry.addName(Items.candyCane, "Candy cane");
		LanguageRegistry.addName(Items.fork, "Fork");
//		LanguageRegistry.addName(mFC.present, "Present");
	}
	
	public static void nameModern(){
		LanguageRegistry.addName(Items.hamburgerOrginal, "Hamburger");
		LanguageRegistry.addName(Items.hamburgerCheese, "Cheeseburger");
		LanguageRegistry.addName(Items.hamburgerBread, "HamBurger Bread");
		LanguageRegistry.addName(Items.hamburgerRaw, "Raw Hamburger Meat");
		LanguageRegistry.addName(Items.hamburger, "Hamburger Meat");
		LanguageRegistry.addName(Items.frenchFries, "French fries");
		LanguageRegistry.addName(Items.hamburgerBacon, "Cheese 'n' BaconBurger");
		LanguageRegistry.addName(Items.hotDog, "HotDog");
		LanguageRegistry.addName(Items.hotDogKetchup, "HotDog with Ketchup");
		LanguageRegistry.addName(Items.bottleOfKetchup, "Ketchup");
	}
}
